    ...
    <>
      ...
      <div style={styles.termsSection}>
        ...
        <div style={styles.termsText}>
          ...
          <a href="/privacy-policy" style={{ color: "#c8a45c", textDecoration: "underline" }}>Privacy Policy</a> and{" "}
          <a href="/terms-of-service" style={{ color: "#c8a45c", textDecoration: "underline" }}>Terms of Service</a>.
        </div>
        <div style={styles.termsText}>
          ...
          <a href="mailto:support@enabledtalent.ca" style={{ color: "#c8a45c", textDecoration: "underline" }}>support@enabledtalent.ca</a>.
        </div>
        <div style={styles.checkboxWrapper}>
          ...
          <label htmlFor="agree-checkbox" style={styles.checkboxLabel}>
            I have read the Privacy Policy and Terms of Service, and I agree to let Enabled HR Labs Inc. collect and use my personal information as described to support my job search. <span style={{ color: "#ef4444" }}>*</span>
          </label>
        </div>
        {errors.agreed && (
